 ...
 * The system now uses a two-tier pricing model based on bike type:
 * - Standard bikes: $1.00 base fee + $0.02/minute
 * - Electric bikes: $3.00 base fee + $0.05/minute
 *
 * Loyalty tiers provide discounts on top of the base pricing:
 * - Bronze: 5% discount
 * - Silver: 10% discount
 * - Gold: 15% discount
 */
